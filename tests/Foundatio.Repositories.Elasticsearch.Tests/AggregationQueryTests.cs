...
namespace Foundatio.Repositories.Elasticsearch.Tests {
    ...
    public sealed class AggregationQueryTests : ElasticRepositoryTestBase {
        ...
        public async Task GetNumberAggregationsAsync() {
            ...
            var result = await _employeeRepository.CountBySearchAsync(q => q.AggregationsExpression(aggregations));
        ...
        public async Task GetNumberAggregationsWithFilterAsync() {
            ...
            var result = await _employeeRepository.CountBySearchAsync(q => q.FilterExpression("age: <40").AggregationsExpression(aggregations));
        ...
        public async Task GetAliasedNumberAggregationsWithFilterAsync() {
            ...
            var result = await _employeeRepository.CountBySearchAsync(q => q.FilterExpression("aliasedage: <40").AggregationsExpression(aggregations));
            Assert.Equal(7, result.Total);
            Assert.Equal(4, result.Aggregations.Count);
        ...
        public async Task GetAliasedNumberAggregationThatCausesMappingAsync() {
            ...
            var thisWillTriggerMappingRefresh = await _employeeRepository.CountBySearchAsync(q => q.FilterExpression("fieldDoestExist:true"));
            Assert.Equal(0, thisWillTriggerMappingRefresh.Total);

            var result = await _employeeRepository.CountBySearchAsync(q => q.AggregationsExpression("cardinality:twitter"));
            Assert.Equal(1, result.Total);
        ...
        public async Task GetTermAggregationsAsync() {
            ...
            var result = await _employeeRepository.CountBySearchAsync(q => q.AggregationsExpression("terms:age"));
            Assert.Equal(10, result.Total);
            Assert.Equal(1, result.Aggregations.Count);
            ...
            result = await _employeeRepository.CountBySearchAsync(q => q.AggregationsExpression("terms:(age~2 @missing:0 terms:(years~2 @missing:0))"));
            Assert.Equal(10, result.Total);
            Assert.Equal(1, result.Aggregations.Count);
