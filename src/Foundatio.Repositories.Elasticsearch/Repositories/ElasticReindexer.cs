...
namespace Foundatio.Repositories.Elasticsearch {
    public class ElasticReindexer {
        ...
        //            _logger.Error().Exception(scanResults.OriginalException).Message("Invalid search result: message={0}", scanResults.GetErrorMessage()).Write();
        ...
        //            _logger.Warn(bulkResponse.OriginalException, message);
        ...
        //                _logger.Error().Exception(response.OriginalException).Message(message);
        ...
        //                message = $"Reindex error: old={workItem.OldIndex} new={workItem.NewIndex} id={itemWithError.Id} completed={completed} message={response.GetErrorMessage()}";
        //                _logger.Error().Exception(response.OriginalException).Message(message);
        //                throw new ReindexException(response, message);
        //            }
        //        }
