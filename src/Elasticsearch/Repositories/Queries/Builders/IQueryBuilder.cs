...
namespace Foundatio.Elasticsearch.Repositories.Queries.Builders {
    public interface IQueryBuilder {
        ...
        void BuildFilter<T>(object query, object options, ref QueryContainer container) where T : class, new();
    ...
    public abstract class QueryBuilderBase : IQueryBuilder {
        ...
        public virtual void BuildFilter<T>(object query, object options, ref QueryContainer container) where T : class, new() { }
